                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h1 class="text-11 font-weight-500 text-white mb-3">A propos de Kimya</h1>
                            <p class="text-5 text-white line-height-4 mb-4">Notre mission est de vous aider à économiser sur les frais de transfert et les taux de change!</p>
                            <a href="{{route('register')}}" class="btn btn-primary m-2">Ouvrez un compte gratuit</a> <a class="btn btn-outline-light video-btn m-2" href="#" data-src="https://www.youtube.com/embed/7e90gBu4pas" data-toggle="modal" data-target="#videoModal"><span class="mr-2"><i class="fas fa-play-circle"></i></span>Regarde comment ça marche</a> </div>
                    </div>
                </div>
            </div>
        </section>
...
<div id="content">
            ...
            <div class="row">
                <div class="col-lg-6 d-flex">
                    <div class="my-auto px-0 px-lg-5 mx-2">
                        <h2 class="text-9">Qui nous sommes</h2>
    ...
    <section class="section bg-white">
        <div class="container">
            <h2 class="text-9 text-center">Nos investisseurs</h2>
            <p class="lead text-center mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <div class="brands-grid separator-border">
                <div class="row align-items-center">
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-1.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-2.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-3.png') }}" alt="Brands"></a></div>
                    ...
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-6.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-7.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-8.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-9.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-10.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-11.png') }}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ asset('images/partner/partner-1.png') }}" alt="Brands"></a></div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            <h2 class="text-9 text-center">Ce que les gens disent de Kimya</h2>
            ...
            <div class="owl-carousel owl-theme" data-autoplay="true" data-nav="true" data-loop="true" data-margin="30" data-slideby="2" data-stagepadding="5" data-items-xs="1" data-items-sm="1" data-items-md="2" data-items-lg="2">
                <div class="item">
                    <div class="testimonial rounded text-center p-4">
                        <p class="text-4">“Facile a utiliser, reasonably priced simply dummy text of the printing and typesetting industry. Quidam lisque persius interesset his et, in quot quidam possim iriure.”</p>
                ...
                <div class="item">
                    <div class="testimonial rounded text-center p-4">
                        <p class="text-4">“Je ne l'ai essayé que depuis quelques jours. Mais jusqu'ici excellent. Semble fonctionner parfaitement. Je ne l'utilise que pour envoyer de l'argent à des amis pour le moment.”</p>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="featured-box text-center">
                        ...
                        <h4 class="text-12 text-white mb-0">27+</h4>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="featured-box text-center">
                        ...
                        <h4 class="text-12 text-white mb-0">03</h4>
                ...
                <div class="col-sm-6 col-md-3 mt-4 mt-md-0">
                    <div class="featured-box text-center">
                        ...
                        <h4 class="text-12 text-white mb-0">780.5k</h4>
